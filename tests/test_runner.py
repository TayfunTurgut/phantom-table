...
def _fake_log(winner: str) -> dict:
    return {
        ...
        "num_players": 2, "seed": 0, "start_time": None, "end_time": None,
        "winner": winner, "rounds_played": 1, "total_turns": 2,
        "archetypes": ["default", "default"], "rule_queries": [],
        "events": [
...
def test_run_multiple_games_writes_logs_and_aggregates(tmp_path, monkeypatch) -> None:
    def fake_run_game(game_config_name, num_players=2, seed=None, log_file=None,
                      verbose=False, archetypes=None):
    ...
    analytics = run_multiple_games("love_letter_classic", num_games=3, num_players=2,
